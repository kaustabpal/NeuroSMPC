...
def run():
	...
	t_1 = time.time()
	obs_pos = []
	files = os.listdir("/home/aditya/Documents/DEB/data/experiments/NuroMPPI_temporal_5-3/data/")
	save_trajs_path = "/home/aditya/Documents/DEB/data/experiments/NuroMPPI_temporal_5-3/trajs/"
	mppi_trajs = []
	grad_cem__trajs = []
	nsmpc_trajs = []

	for i in range(153, len(files)):
		print(i, )
		plt.clf()
		file_name ="/home/aditya/Documents/DEB/data/experiments/NuroMPPI_temporal_5-3/data/" + "data_" + str(i).zfill(3) + ".pkl"
		...
		# print(ego_theta)
		obs_pos_frenet = []
		for do in range(len(dyn_obs)):
			obs_traj = global_to_frenet(obs_poses[do], new_g_path, interpolated_g_path)
		...
		for ofd in range(len(obs_pos_frenet)):
			plt.scatter(obs_poses[ofd][:,0],obs_poses[ofd][:,1],color='grey')
		...
		# nsmpc_trajs.append(traj_nmppi_dyn)
		...
		# mppi_trajs.append(traj_sampler)
		...
		# grad_cem__trajs.append(traj_cem)
		...
		plt.xlim(-15, 15)
		plt.ylim(-15, 15)
		plt.savefig("data/" + str(i).zfill(3) + ".png", dpi=1000)
		plt.show()
		# plt.pause(0.001)
        ...
        #     "mppi": traj_sampler,
        #     "gradcem": traj_cem,
        #     "nsmpc": traj_nmppi_dyn,
	    #     "obstacles": obs_pos
        # }


		# file_name_trajs = save_trajs_path + str(i).zfill(3) + ".pkl"
		# with open(file_name_trajs, "wb") as f:
